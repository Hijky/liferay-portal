...
- ### By File Extensions:
   ...
   - [.function, .jar, .lar, .macro, .testcase, .war or .zip](src/main/resources/documentation/poshi_source_processor_checks.markdown#checks-for-function-jar-lar-macro-testcase-war-or-zip)
